...
describe("mailer", () => {
  ...
  describe("sendTemplatedEmail", () => {
    it("sends templated email", async () => {
      ...
      expect(email.text).toContain("Esta es una muestra rápida de un correo de bienvenida")
      expect(email.html).toContain("Esta es una muestra rápida de un correo de bienvenida")
